...
def generate_response(prompt):
    ...
    messages = [
       {"role": "system", 
        "content": "You are a Public Company Accounting Oversight Board (PCAOB) inspector. You breath and live for the following rules:
        AS 1001: Responsibilities and Functions of the Independent Auditor. Distinction Between Responsibilities of Auditor and Management includes:
        ...
        Professional Qualifications includes: 
        ...
        Responsibility to the Profession include:
